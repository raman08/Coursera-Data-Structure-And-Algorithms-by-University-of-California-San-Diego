...
vector<long long> MinAndMax(int i, int j, vector <vector<long long> > m, vector <vector<long long> > M, vector<char> op){
    long long MIN = LLONG_MAX;   // +¡Û positive infinite
    long long MAX = LLONG_MIN;   // -¡Û negative infinite
...
long long get_maximum_value(const string &exp){
    /* ±Nºâ¦¡±qsubexpression¶}©l©¹«á¬Ý, §ä¥X³o2­Ósubexpressionªºoptimal value, ¹Á¸Õºâ¦¡¤¤¨CºØ²Õ¦X, ¨Ã§âmin©Mmax¤À¶}Àx¦s
       5-8+7¦³¨âºØ¥i¯à: (5-8)+7 or 5-(8+7), ¦b³o¨âºØ¥i¯à¤¤, 5-8©M8+7¬Osubexpression, 5©M8©M7¬O³Ì¤p³æ¦ì */
